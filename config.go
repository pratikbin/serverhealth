...
// GetEnabledNotifications returns all enabled notification configurations
...
// GetEnvBool returns a boolean value from environment variable
...
// GetEnvInt returns an integer value from environment variable
...
// GetEnvString returns a string value from environment variable
